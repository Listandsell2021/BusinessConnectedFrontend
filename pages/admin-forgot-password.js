...
export default function AdminForgotPassword() {
  ...
  return (
    <>
      <Head>
        <title>
          {isGerman ? 'Admin Passwort vergessen - Business Connected' : 'Admin Forgot Password - Business Connected'}
        </title>
        <meta name="description" content={isGerman ? 'Setzen Sie Ihr Admin-Passwort zurück' : 'Reset your admin password'} />
      </Head>
      ...
      >
            ...
            >
              ...
              <div className="relative z-10">
                <div className="text-center mb-6 sm:mb-8 lg:mb-10">
                  ...
                  >
                    {isGerman ? 'Admin Passwort zurücksetzen' : 'Reset Admin Password'}
                  </motion.h2>
                  <motion.p
                    ...
                    >
                      <motion.button
                        ...
                        className={`
                          ...
                          ${isSubmitting ? 'opacity-70 cursor-not-allowed' : 'hover:shadow-lg hover:shadow-blue-500/25 hover:scale-102'}
                        `}
                    ...
                    >
                      ...
                      <input
                        ...
                        className={`
                          ...
                          ${errors.otp ? 'border-red-400 focus:border-red-400 focus:ring-red-400' : 'border-gray-300 dark:border-gray-200/30 focus:border-blue-400 focus:ring-blue-400'}
                        `}
                        style={{
                          backgroundColor: 'var(--theme-bg-secondary, rgba(0, 0, 0, 0.05))',
                      ...
                      <div className="relative">
                        <input
                          ...
                          className={`
                            ...
                            backdrop-blur-sm transition-all duration-300
                            focus:outline-none focus:ring-4 focus:ring-opacity-30 focus:scale-105 text-sm sm:text-base
                            ${errors.newPassword ? 'border-red-400 focus:border-red-400 focus:ring-red-400' : 'border-gray-300 dark:border-gray-200/30 focus:border-blue-400 focus:ring-blue-400'}
                          `}
                          style={{
                            backgroundColor: 'var(--theme-bg-secondary, rgba(0, 0, 0, 0.05))',
                      ...
                      <div className="relative">
                        <input
                          ...
                          className={`
                            ...
                            backdrop-blur-sm transition-all duration-300
                            focus:outline-none focus:ring-4 focus:ring-opacity-30 focus:scale-105 text-sm sm:text-base
                            ${errors.confirmPassword ? 'border-red-400 focus:border-red-400 focus:ring-red-400' : 'border-gray-300 dark:border-gray-200/30 focus:border-blue-400 focus:ring-blue-400'}
                          `}
                          style={{
                            backgroundColor: 'var(--theme-bg-secondary, rgba(0, 0, 0, 0.05))',
        ...
        {/* Right Side - Process Steps Visualization - Hidden for Admin (can be used for partner in future)
        <div className="hidden md:block relative w-0 flex-1">
          ...
          >
            <div className="text-center p-6 sm:p-8 max-w-lg relative z-10">
              <motion.h3
                className="text-2xl sm:text-4xl font-bold mb-6 sm:mb-8 bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 bg-clip-text text-transparent"
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ delay: 0.5 }}
              >
                {isGerman ? 'Admin Passwort-Reset' : 'Admin Password Reset'}
              </motion.h3>

              {/* Process Steps - for future use
                  ...
                  >
                    ...
                    <div className="text-left">
                      <div className={`font-bold text-base sm:text-lg transition-all duration-300 ${
                        ...
                        processStep.active ? 'text-blue-400' : 'text-gray-400'
                      }`}>
                        {processStep.title}
                      </div>
