...
async function testEmailConfiguration() {
  ...
  try {
    ...
    const testEmail = {
      ...
      subject: 'Email Configuration Test - Umzug Anbieter Vergleich System',
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          ...
          <div style="padding: 20px;">
            ...
            <p>Your Umzug Anbieter Vergleich email system is now properly configured and working!</p>
          ...
          <div style="background: #f0f0f0; padding: 10px; text-align: center; font-size: 12px;">
            This is an automated test message from the Umzug Anbieter Vergleich email system.
          </div>
        </div>
      `
    };
